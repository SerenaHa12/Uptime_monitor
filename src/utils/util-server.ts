 ...
 */
export const tcping = function (hostname, port): Promise<number> {
 ...
 */
export const ping = async (hostname): Promise<number> => {
    try {
        return await  pingAsync(hostname);
    } catch (e) {
        // If the host cannot be resolved, try again with ipv6
        if (e.message.includes("service not known")) {
            return await pingAsync(hostname, true);
        } else {
            throw e;
        }
    }
 ...
 * @returns {Promise<number>} Time for ping in ms rounded to nearest integer
 */
export const pingAsync = function (hostname, ipv6 = false): Promise<number> {
    return new Promise((resolve, reject) => {
        pingModule.promise.probe(hostname, {
            v6: ipv6,
            min_reply: 1,
            timeout: 10,
        }).then((res) => {
 ...
 */
export const mqttAsync = function (hostname, topic, okMessage, options: any = {}): Promise<string> {
    return new Promise((resolve, reject) => {
 ...
 */
export const httpNtlm = function (options, ntlmOptions) {
    return new Promise((resolve, reject) => {
 ...
 * @returns {Promise<(string[]|Object[]|Object)>}
 */
export const dnsResolve = function (hostname, resolverServer, resolverPort, rrtype): Promise<any> {
 ...
 * @returns {Promise<(string[]|Object[]|Object)>}
 */
export const mssqlQuery = async function (connectionString, query) {
    let pool;
    try {
 ...
 * @returns {Promise<(string[]|Object[]|Object)>}
 */
export const postgresQuery = function (connectionString, query) {
    return new Promise((resolve, reject) => {
 ...
 * @returns {Promise<(string[]|Object[]|Object)>}
 */
export const mysqlQuery = function (connectionString, query) {
    return new Promise((resolve, reject) => {
 ...
 */
// export const setting = async function (key) {
 ...
 */
// export const setSetting = async function (key, value, type = null) {
 ...
 * @returns {Promise<Bean>}
 */
// export const getSettings = async function (type) {
 ...
 * @returns {Promise<void>}
 */
// export const setSettings = async function (type, data) {
 ...
 */
export const checkCertificate = function (res) {
 ...
 */
export const checkStatusCode = function (status, acceptedCodes) {
...
/** Start Unit tests */
export const startUnitTest = async () => {
 ...
 */
export const grpcQuery = async (options): Promise<grpcResponse> => {
    const { grpcUrl, grpcProtobufData, grpcServiceName, grpcEnableTls, grpcMethod, grpcBody } = options;
    const protocObject = protojs.parse(grpcProtobufData);
    const protoServiceObject = protocObject.root.lookupService(grpcServiceName);
    const Client = grpc.makeGenericClientConstructor(grpcMethod, grpcServiceName, {});
    const credentials = grpcEnableTls ? grpc.credentials.createSsl() : grpc.credentials.createInsecure();
    const client = new Client(
        grpcUrl,
        credentials
    );
    const grpcService = protoServiceObject.create(function (method: any, requestData, cb)  {
